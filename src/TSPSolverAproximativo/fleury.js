...
const removeEdge = (multiGraph, edge) => {
...
const findVertexEdges = (multigraph, v) => {
...
const reachableVertexCountOf = (combinedMst, currentVertex) => {

    const visited = [currentVertex];
    const recurse = (combinedMst, currentVertex) => {
